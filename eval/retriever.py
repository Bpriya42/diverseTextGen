"""
Retriever for ICAT Evaluation

Dense retriever specifically for the eval module.
"""
...
class Retriever:
    """
    Dense retriever using Sentence Transformers and FAISS for ICAT evaluation.
    """
            ...
            if num_snippets > 50000:
                ...
                if use_gpu:
                    try:
                        ...
                        print(f"FAISS GPU index building failed ({e}), using CPU")
                ...
                if use_gpu:
                    try:
                        ...
                        print(f"FAISS GPU index creation failed ({e}), using CPU")
    ...
    def retrieve(self, query: str, top_k: int = 10) -> List[Tuple[str, str, float]]:
